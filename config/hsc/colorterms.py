...
config.data = {
    "hsc*": ColortermDict(data={
        ### it seems these settings have no effect on the processCCD outputs when compared to the ps1 dataset.
        ...
        'w': Colorterm(primary="g", secondary="g"),
        'gri': Colorterm(primary="g", secondary="g"),
        ...
        'EB-GRI': Colorterm(primary="g", secondary="g"),
    }),
    ...
    "ps1*": ColortermDict(data={
        ...
        #'EB-GRI': Colorterm(primary="g", secondary="g", c0=0.0, c1=0.0, c2=0.0), ## thesee definitely affect the zeropoints!
        #'gri': Colorterm(primary="g", secondary="g", c0=0.0, c1=0.0, c2=0.0),
        # correct I think
        'EB-GRI': Colorterm(primary="g", secondary="i", c0=-0.0282, c1=-0.4621, c2=-0.0591),
        'gri': Colorterm(primary="g", secondary="i", c0=-0.0282, c1=-0.4621, c2=-0.0591), ### this is the Colorterm  that seems to be used by procCcd
        'w': Colorterm(primary="g", secondary="i", c0=-0.0282, c1=-0.4621, c2=-0.0591), ### this is used by tests, but not by processCCD...
        #'gri': Colorterm(primary="g", secondary="r", c0=0.0622, c1=-0.7107, c2=-0.1463),
    }),
}
